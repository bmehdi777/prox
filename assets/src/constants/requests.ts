...
export const sampleRequests: Request[] = [
  { id: 1, method: "GET", url: "https://api.example.com/users", status: 200, duration: "120ms" },
  { id: 2, method: "POST", url: "https://api.example.com/auth/login", status: 201, duration: "340ms" },
  { id: 3, method: "GET", url: "https://api.example.com/products", status: 200, duration: "89ms" },
  { id: 4, method: "PUT", url: "https://api.example.com/users/42", status: 200, duration: "156ms" },
  { id: 5, method: "DELETE", url: "https://api.example.com/posts/15", status: 204, duration: "78ms" },
  { id: 6, method: "GET", url: "https://api.example.com/orders", status: 500, duration: "2100ms" },
  { id: 7, method: "PATCH", url: "https://api.example.com/settings", status: 200, duration: "95ms" },
  { id: 8, method: "GET", url: "https://api.example.com/notifications", status: 404, duration: "45ms" },
  { id: 9, method: "POST", url: "https://api.example.com/upload", status: 201, duration: "890ms" },
  { id: 10, method: "GET", url: "https://api.example.com/dashboard", status: 200, duration: "210ms" },
  { id: 1, method: "GET", url: "https://api.example.com/users", status: 200, duration: "120ms" },
  { id: 2, method: "POST", url: "https://api.example.com/auth/login", status: 201, duration: "340ms" },
  { id: 3, method: "GET", url: "https://api.example.com/products", status: 200, duration: "89ms" },
  { id: 4, method: "PUT", url: "https://api.example.com/users/42", status: 200, duration: "156ms" },
